<x-layout.property category="Border" title="Border Width" :tokens="$tokens">
        ...
        <div class="apply__item">
            ...
            <div class="item__box">
                <div class="box__display">
                    <div class="{{ $tokens['prefix'] }}-{{ $token['key'] }}" style="height: 50px; width: 50px; border-style: solid; border-color: white"></div>
                </div>
                <div class="box__code">

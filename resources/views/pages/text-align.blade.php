<x-layout.property category="Typography" title="Text Align" :tokens="$tokens">
        ...
        <div class="apply__item">
            ...
            <div class="item__box">
                <div class="box__display">
                    <p class="{{ $tokens['prefix'] }}-{{ $token['key'] }}" style="font-size: 1.5em">Bicraft is where creativity meets craft in digital form.</p>
                </div>
                <div class="box__code">
